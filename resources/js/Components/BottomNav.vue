<template>
 <div class="left-0 bottom-0 fixed tabs flex items-center bg-base-300 w-full justify-center h-20">
      ...
      <BreezeNavLink label="Campaign" :href="route('campaign.show')" :active="route().current('campaign.show')">
      <div class="flex flex-col justify-center items-center">
      ...
      <div class="flex flex-col justify-center items-center">
          <svg xmlns="http://www.w3.org/2000/svg"  fill="currentColor" class="bi bi-person-fill w-7 h-7" viewBox="0 0 20 20">
